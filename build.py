...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','18','--version-name','0.9.8-fotto-payload-fix','-o',build/'unsigned.apk',build/'resources.zip')
