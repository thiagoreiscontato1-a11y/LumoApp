...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','23','--version-name','0.12.0-ux-workflow-curation-score','-o',build/'unsigned.apk',build/'resources.zip')
