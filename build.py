...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','32','--version-name','0.14.6-build-fix','-o',build/'unsigned.apk',build/'resources.zip')
