...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','14','--version-name','0.9.4-fotto-debug','-o',build/'unsigned.apk',build/'resources.zip')
