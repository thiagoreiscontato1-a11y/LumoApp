...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','31','--version-name','0.14.5-fotto-background-monitor','-o',build/'unsigned.apk',build/'resources.zip')
