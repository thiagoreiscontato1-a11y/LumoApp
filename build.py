...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','28','--version-name','0.14.2-fotto-folder-picker','-o',build/'unsigned.apk',build/'resources.zip')
