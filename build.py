...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','17','--version-name','0.9.7-fotto-dual-auth','-o',build/'unsigned.apk',build/'resources.zip')
