...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','16','--version-name','0.9.6-fotto-bearer-fix','-o',build/'unsigned.apk',build/'resources.zip')
