...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','36','--version-name','0.15.0-fotto-direto','-o',build/'unsigned.apk',build/'resources.zip')
