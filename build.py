...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','37','--version-name','0.15.1-r8-stop-envio','-o',build/'unsigned.apk',build/'resources.zip')
