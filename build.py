...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','35','--version-name','0.14.9-fotto-editadas-path','-o',build/'unsigned.apk',build/'resources.zip')
