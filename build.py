...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','29','--version-name','0.14.3-fotto-folder-persist','-o',build/'unsigned.apk',build/'resources.zip')
