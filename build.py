...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','30','--version-name','0.14.4-fotto-opfs-mirror','-o',build/'unsigned.apk',build/'resources.zip')
