...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','39','--version-name','0.15.4-fotto-long-queue','-o',build/'unsigned.apk',build/'resources.zip')
