...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','19','--version-name','0.10.0-curation-backfill','-o',build/'unsigned.apk',build/'resources.zip')
