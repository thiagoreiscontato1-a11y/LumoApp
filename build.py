...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','40','--version-name','0.15.5-fotto-long-queue-build-fix','-o',build/'unsigned.apk',build/'resources.zip')
