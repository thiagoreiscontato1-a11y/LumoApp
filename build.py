...
run(tools/'aapt2','link','-I',android,'--manifest',p/'app/src/main/AndroidManifest.xml','-A',p/'app/src/main/assets','--version-code','26','--version-name','0.14.0-fotto-web','-o',build/'unsigned.apk',build/'resources.zip')
